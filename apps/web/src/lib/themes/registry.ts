...
export const ADMIN_THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: "lilac",
    label: "Lilac Banking",
    description: "Soft lilac with teal accents from Design41.",
    swatches: ["#f1c6fb", "#b193bf", "#31879b", "#204e4b"],
    previewImage: "/themes/design41.png",
  },
  {
    id: "azalea",
    label: "Azalea Analytics",
    description: "Warm greys with azalea pink highlights from Design42.",
    swatches: ["#fbfafb", "#d83e65", "#aca2a6", "#282727"],
    previewImage: "/themes/design42.png",
  },
  {
    id: "nature",
    label: "Nature",
